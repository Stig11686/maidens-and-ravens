 ...
 ?>
  <section class="flex pt-12 lg:pt-36 pb-8 px-6 xl:px-48 lg:px-24 mx-auto ">
    <div class="flex flex-col lg:flex-row lg:justify-between  items-start gap-10 max-w-7xl mx-auto">
      ...
      <div class="bg-grey-2000 h-full w-full lg:w-6/12">
        <img src="<?php echo esc_url(get_theme_mod('elizabeth_image_1')); ?>" alt="Image of Elizabeth at Maidens and Ravens Bridal Boutique York" class="w-full h-full object-cover">
      </div>
    </div>
  </section>
  ...
  <section class="flex pt-4 pb-8 px-6 xl:px-48 lg:px-24 mx-auto ">
    <div class="flex flex-col lg:flex-row lg:justify-between  items-start gap-10 max-w-7xl mx-auto">
      ...
      <div class="flex flex-col items-start gap-8 decorated-list lg:w-5/12 lg:order-2">
        ...
        <p class="text-wrap text-lg">I opened my original Reloved boutique in 2019 and after winning the Best Bridal Boutique in Yorkshire in 2022, 2023 and I became fully independent in 2024 choosing to better adapt my boutique to my brides.</p>
      </div>
    </div>
  </section>
