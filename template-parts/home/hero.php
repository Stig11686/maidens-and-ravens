...
<div class="bg-gray-900">
  ...
  <div class="relative isolate overflow-hidden pt-14">
    <img src="<?php echo $hero_image; ?>" alt="Maidens and Ravens Bridal Boutique York showing one time only wedding dresses in our magical, unique Boutique" class="absolute inset-0 -z-10 h-full w-full object-cover">
