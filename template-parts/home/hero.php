  ...
  <div id="header" class="relative isolate overflow-hidden pt-14">
    ...
    <div class="mx-auto flex flex-col items-center justify-center gap-8 max-w-2xl py-32 sm:py-48 lg:py-40">
      <div class="text-center z-50">
        ...
        <h1 class="mt-6 text-4xl lg:text-5xl font-semibold leading-normal text-gray-300">Discover the magic at Maidens & Ravens,
          a unique bridal boutique in the heart of York.</h1>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="#" class="rounded-md bg-purple-900 px-3.5 py-2.5 text-xl font-semibold text-white shadow-sm hover:bg-purple-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-400">Book an Appointment</a>
          <a href="/products/all/" class="text-xl font-semibold leading-6 text-white">View Our Dresses <span aria-hidden="true">→</span></a>
        </div>
      </div>
    </div>
  </div>
