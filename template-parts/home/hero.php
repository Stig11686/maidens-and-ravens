...
<div class="relative">
  ...
  <div id="header" class="relative isolate overflow-hidden pt-14">
    ...
    <div class="absolute inset-x-0 inset-y-0 overflow-hidden bg-black/90" aria-hidden="true">
    </div>
    <div class="mx-auto flex flex-col items-center justify-center gap-8 max-w-2xl py-32 sm:py-48 lg:py-40">
      <div class="text-center z-50">
        ...
        <h1 class="mt-6 text-4xl lg:text-5xl font-semibold leading-8 text-gray-300">Discover the magic at Maidens & Ravens,
