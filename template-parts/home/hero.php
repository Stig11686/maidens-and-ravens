...
<div class="relative">
  <div id="header" class="relative min-h-screen flex flex-col md:flex-row isolate overflow-hidden pt-14 rounded-b-[100px]">
    <div class="maidens relative flex-1 flex items-center justify-center bg-white" style="background-image: url('<?php echo get_template_directory_uri(  ) . '/img/raven.svg';?>'); background-position: bottom; background-repeat: no-repeat; background-size: cover;">
