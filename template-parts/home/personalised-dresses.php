<div class="w-full flex flex-col lg:flex-row lg:justify-between">
    <div class="w-full lg:w-1/2 p-6 flex flex-col gap-1 bg-blue-900">
        ...
        <div class="w-full" style="background-image: url('<?php echo get_template_directory_uri(  ) . '/img/brides/maidens-and-ravens-bride-2.jpg'; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; padding-top: 80%;"></div>
        <div class="w-full" style="background-image: url('<?php echo get_template_directory_uri(  ) . '/img/brides/maidens-and-ravens-bride-3.jpg'; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; padding-top: 80%;"></div>
        <div class="w-full" style="background-image: url('<?php echo get_template_directory_uri(  ) . '/img/brides/maidens-and-ravens-bride-4.jpg'; ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; padding-top: 80%;"></div>
