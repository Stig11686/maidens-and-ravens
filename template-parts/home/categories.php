        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-48">
                ...
                <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 gap-8 lg:space-y-0">
                    ...
                    ?>
                    <div data-aos="fade-up-right" data-aos-duration="800" data-aos-easing="ease-in-out" data-aos-delay="<?php echo ($index * 100) + 500; ?>" class="group relative flex flex-col items-start self-stretch bg-transparent rounded-lg overflow-hidden pb-6 shadow-2xl">
                        ...
                        <div class="image-frame-content px-8 flex flex-col h-full justify-between gap-8 self-stretch">
                            ...
                            <a href="<?php echo esc_url( $category_link ); ?>" class="btn bg-transparent text-sm font-semibold text-white ">View Collection</a>
                        </div>
                    </div>  
