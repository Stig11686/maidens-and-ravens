        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
                ...
                <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 gap-8 lg:space-y-0">
                    ...
                    ?>
                    <div data-aos="fade-up-right" data-aos-duration="4000" data-aos-easing="ease-in-out" data-aos-delay="<?php echo ($index * 10) + 450; ?>" class="group relative flex flex-col items-start self-stretch bg-card-bg rounded-lg overflow-hidden pb-6">
