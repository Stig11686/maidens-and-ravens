    ...
    <div class="text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
                <h2 class="text-2xl font-bold text-white">View our Dresses</h2>
                ...
                <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 gap-8 lg:space-y-0">
                    ...
                    ?>
                    <div class="group relative flex flex-col items-start self-stretch shadow-lg shadow-yellow-900 rounded-lg overflow-hidden pb-6">
                        ...
                        <div class="image-frame-content px-8">
                            <h3 class="my-6 text-xl text-white font-semibold">
