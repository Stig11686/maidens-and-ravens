<div class="px-6 lg:contents relative">
      <div class="mx-auto flex flex-col items-start gap-8">
        <h2 class="mt-2 text-3xl leading-8 tracking-tight sm:text-5xl">Meet <span class="text-primary">Elizabeth</span></h3>
        <p class="my-6 text-xl leading-8">Hello my Queens.<br>
        ...
        I am Elizabeth and I am the founder, owner and award winning bridal mavern at Maidens and Ravens, here in the historic city of York. </p>
          <p class="text-xl leading-normal">Did you know that a mavern is someone who is experienced and knowledgeable? Seemed like a fitting name for me...</p>
