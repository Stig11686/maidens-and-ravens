<div class="max-w-7xl px-6 mx-auto">
  <div class="w-10/12 max-w-7xl text-white flex flex-col items-start gap-8 py-16">
    <p data-aos="fade-up-right" data-aos-duration="500" data-easing="ease-in" class="text-3xl lg:text-5xl/normal leading-normal mb-0">"Be our guest; our stunning collection of one-off dresses are fully customisable, allowing us to add your personality, vision 
