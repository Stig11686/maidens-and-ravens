<div class="max-w-7xl px-6 mx-auto">
  <div class="w-10/12 max-w-7xl flex flex-col items-start gap-8 py-32">
...
<div class="w-full flex flex-col lg:flex-row ">
  ...
  <div class="w-full lg:w-1/2 order-1 lg:order-2">
    <img src="<?php echo wp_get_attachment_image_url( 652, 'large' ) ; ?>" alt="Our promise on sustainability" class="h-full w-full object-cover">
  </div>
</div>
