        ...
        <dl class="mt-10 space-y-6 divide-y divide-gray-900/10 faqs-section">
          <div class="cursor-pointer flex flex-col items-center max-w-7xl mx-auto bg-white faq">
              ...
              while ($faqs->have_posts()) : $faqs->the_post(); ?>
                  <div class="py-4 border-gray-500 border px-6 w-full">
                      <div class="flex justify-between items-center self-stretch faq-btn">
                          <div class="flex items-center gap-2">
                              <div class="flex flex-col justify-center text-sm font-bold text-grey-600"><?php the_title(); ?></div>
                          </div>
                          <div>
                      ...
                      <div class="flex flex-col self-stretch gap-8 faq-content box-content">
                          <?php the_content(); ?>
                      </div>
                  </div>
              <?php endwhile; ?>
