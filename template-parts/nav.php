...
<nav class="flex justify-between items-center gap-8 p-8 max-w-screen-2xl mx-auto text-white">
    <div class="flex items-center z-50 self-start cursor-pointer">
        ...
        <?php wp_nav_menu(array('theme_location' => 'second-hero','menu_class' => 'flex gap-4 list-none pl-2', 'add_li_class' => 'text-white uppercase text-xs font-bold hover:underline')); ?>
    </div>
    ...
    <div class="hidden md:block gap-8 self-start text-white">
        <div class="flex gap-8 items-center">
            <a href="#" class="px-4 py-2 bg-yellow-900 text-blue-900 cursor-pointer rounded-2xl text-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-400">Book an Appointment</a>
