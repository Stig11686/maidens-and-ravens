    ...
    <div class="px-6 flex flex-col gap-8">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2 flex flex-col gap-8 p-12 text-center">
                ...
                <a href="#" class="button button--wayra border border-1 rounded border-purple-900 px-4 py-5 outline outline-1 -outline-offset-2 outline-purple-900 uppercase" data-text="Click to Book an Appointment">Click to Book an Appointment</a>
